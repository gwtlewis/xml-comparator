...
impl BenchmarkRunner {
    ...
    fn benchmark<F>(&mut self, name: &str, iterations: usize, operation: F)
    where
        F: Fn() -> (),
    {
    ...
    fn benchmark_single_comparisons(&mut self) {
        ...
        self.benchmark("Depth 2 - Identical", 10000, move || {
            service.compare_xmls(&xml_d2_1, &xml_d2_2);
        });
        
        // Depth 2 different
        let xml_d2_3 = generate_xml_depth_2(456, "doc2");
        let service = &self.service;
        self.benchmark("Depth 2 - Different", 10000, move || {
            service.compare_xmls(&xml_d2_1, &xml_d2_3);
        });
        ...
        let service = &self.service;
        self.benchmark("Depth 3 - Identical", 5000, move || {
            service.compare_xmls(&xml_d3_1, &xml_d3_2);
        });
        
        // Depth 3 different
        let xml_d3_3 = generate_xml_depth_3(456, "doc2");
        let service = &self.service;
        self.benchmark("Depth 3 - Different", 5000, move || {
            service.compare_xmls(&xml_d3_1, &xml_d3_3);
        });
        ...
        let service = &self.service;
        self.benchmark("Depth 5 - Identical", 1000, move || {
            service.compare_xmls(&xml_d5_1, &xml_d5_2);
        });
        
        // Depth 5 different
        let xml_d5_3 = generate_xml_depth_5(456, "doc2");
        let service = &self.service;
        self.benchmark("Depth 5 - Different", 1000, move || {
            service.compare_xmls(&xml_d5_1, &xml_d5_3);
        });
    }
